(() => {
  // A produção já incorpora este fluxo diretamente no app.js. Mantemos o
  // arquivo promovido do ambiente de homologação, mas evitamos registrar os
  // mesmos handlers duas vezes quando a implementação integrada está ativa.
  if (typeof renderProduction === 'function' && typeof hasStopEvidence === 'function') return;
