...
class VisualParityTests(unittest.TestCase):
    ...
    def test_visual_assets_force_a_fresh_browser_version(self):
        ...
        self.assertIn('styles.css?v=report-download-auth-20260821-1', html)
        self.assertIn('app.js?v=report-download-auth-20260821-1', html)
    ...
    def test_all_current_test_ui_layers_are_loaded_in_production(self):
        ...
        for asset in assets:
            ...
            self.assertIn(f'/{asset}?v=report-download-auth-20260821-1', html)
